...
```{R graf1, out.height="35%", fig.cap = "Scatter plot com distribuição marginal do lucro e vendas das 10 maiores empresas do mundo", fig.align="center" }
...
```{R graf2, out.height="35%", fig.cap = "Scatter plot com distribuição marginal do lucro e vendas das 10 maiores empresas do mundo", fig.align="center"  }
...
```{R graph3d, out.height="50%", fig.caption= "Associação entre x1, x2 e x3, com a cor em x4."}
...
```{R graph3,out.height="35%", fig.caption= "Gráfico de mosaico entre Idade e Exame"}
mosaicplot(data3)
```
